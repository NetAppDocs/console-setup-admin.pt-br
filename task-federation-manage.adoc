...
[role="lead"]
Você pode gerenciar sua federação no NetApp Console. Você pode desativá-la, atualizar credenciais expiradas, assim como excluí-la se não precisar mais dela.
...
[NOTE]
====
* Se você configurou a federação usando o NetApp Cloud Central, importe-a por meio da página *Federação* para gerenciá-la no Console.link:task-federation-import.html["Aprenda como importar sua federação"]
* Na página de Auditoria, você pode visualizar eventos de gerenciamento de federação, como ativação, desativação e atualização de federações. link:task-monitor-cm-operations.html["Saiba mais sobre o monitoramento de operações no NetApp Console."]
...
. Selecione *Administração > Identidade e acesso*.
. Selecione a aba *Federação*.
. Selecione o menu de ações image:button_3_vert_dots.png["um ícone com três pontos verticais"] ao lado da federação que deseja testar e selecione *Testar conexão*.
...
. Selecione *Administração > Identidade e acesso*.
. Selecione a aba *Federação*.
. Selecione o menu de ações image:button_3_vert_dots.png["um ícone com três pontos verticais"] ao lado da federação que deseja desativar e selecione *Desativar*.
...
. Selecione o menu de ações image:button_3_vert_dots.png["um ícone com três pontos verticais"] ao lado da federação que deseja excluir e selecione *Excluir*.
