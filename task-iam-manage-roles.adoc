...
Você pode atribuir funções de acesso por projeto ou pasta. Por exemplo, atribua uma função a um usuário para dois projetos específicos ou atribua a função no nível da pasta para conceder a um usuário a função de administrador de Ransomware Resilience para todos os projetos em uma pasta.
...
[[manage-permissions]]
== Veja a(s) função(ões) atribuída(s) a um membro

Você pode verificar quais funções estão atribuídas ao membro atualmente.
