...
| link:reference-iam-gcnv-roles.html["Usuário do Google Cloud NetApp Volumes"] | Usuários com a função de usuário Google Cloud NetApp Volumes podem visualizar os Google Cloud NetApp Volumes. 
