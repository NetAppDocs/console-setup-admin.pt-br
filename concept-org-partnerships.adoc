...
keywords: organization partnerships, partner access, Partnership admin role, Partnership viewer role, organization ID, managed service provider, MSP collaboration, reseller access, cross-organization management, delegated administration 
...
---
= Parcerias organizacionais no NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Atribua a função de Partnership admin a um ou mais usuários, tanto na organização iniciadora quanto na receptora, para criar e gerenciar parcerias. Você pode atribuir a função de Partnership viewer a usuários que precisam apenas visualizar parcerias, não gerenciá-las.
