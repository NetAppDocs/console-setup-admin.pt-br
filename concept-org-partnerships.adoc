...
Atribua a função Partnership admin a um ou mais usuários, tanto na organização iniciadora quanto na receptora, para criar e gerenciar parcerias. você pode atribuir a função Partnership viewer a usuários que precisam apenas visualizar parcerias, e não gerenciar.
