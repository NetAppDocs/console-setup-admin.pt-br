...
* link:task-install-agent-aws-console.html["Crie o agente do Console diretamente do Console"](esta é a opção padrão)
+
Esta ação inicia uma instância do EC2 executando o Linux e o software do agente do Console em uma VPC de sua escolha.

* link:task-install-agent-aws-marketplace.html["Crie um agente de console no AWS Marketplace"]
+
...
* link:task-install-agent-aws-manual.html["Baixe e instale manualmente o software em seu próprio host Linux"]
