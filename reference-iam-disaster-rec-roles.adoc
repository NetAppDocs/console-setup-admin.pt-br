...
* *Administrador de Recuperação de Desastres*: Execute quaisquer ações necessárias.
* *Administrador de failover de recuperação de desastres*: Executar failover e migrações.
* *Administrador do aplicativo de recuperação de desastres*: Criar planos de replicação. Modificar planos de replicação. Iniciar failovers de teste.
* *Visualizador de Recuperação de Desastres*: Exibe apenas informações.
