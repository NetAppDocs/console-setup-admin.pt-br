...
* *Administrador de failover de recuperação de desastres*: executar failovers e migrações.
* *Administrador de aplicações de recuperação de desastres*: criar e modificar planos de replicação; iniciar testes de failover.
...
|===
| Ação | Administrador de recuperação de desastres | Administrador de failover de recuperação de desastres | Administrador do aplicativo de recuperação de desastres | Visualizador de recuperação de desastres 


5+| *Ativação e descoberta* 
...
| Criar, atualizar ou excluir credenciais  a| 
Sim
 a| 
Sim
 a| 
...
| Adicionar, modificar ou excluir sites ou clusters  a| 
Sim
 a| 
Não
 a| 
...
| Criar ou modificar transformações de recursos  a| 
Sim
 a| 
Sim
 a| 
