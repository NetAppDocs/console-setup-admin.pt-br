...
---
= Permissões do Azure para o agente do NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.3+| Use conjuntos de dimensionamento de máquinas virtuais no modo de orquestração flexível para especificar zonas específicas para Cloud Volumes ONTAP | Microsoft.Compute/virtualMachineScaleSets/gravação | Sim | Não | Não 
