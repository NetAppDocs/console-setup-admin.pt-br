...
summary: O grupo de segurança do Azure para o agente requer regras de entrada e de saída. O NetApp Console cria automaticamente esse grupo de segurança quando você cria um agente do Console. Para outras opções de instalação, você precisa configurar esse grupo de segurança manualmente. 
---
= NetApp Console regras de grupo de segurança do agente no Azure
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
