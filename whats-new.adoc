...
keywords: 'what"s new, features, new, release notes, enhancements, fixes, agent, Console agent, NetApp Console, iam, notice, releases, console' 
summary: Descubra as novidades na administração do NetApp Console. 
---
= O que há de novo no NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NetApp Console 4.9.0 administração inclui o seguinte novo recurso.
