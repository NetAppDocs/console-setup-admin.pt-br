...
summary: As regras de firewall do Google Cloud para o agente exigem regras de entrada e de saída. O NetApp Console cria automaticamente esse grupo de segurança quando você cria um agente do Console. Para outras opções de instalação, você precisa configurar esse grupo de segurança manualmente. 
---
= NetApp Console regras de firewall do agente no Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
As regras de firewall do Google Cloud para o agente exigem regras de entrada e de saída. O NetApp Console cria automaticamente esse grupo de segurança quando você cria um agente do Console. Para outras opções de instalação, você precisa configurar esse grupo de segurança manualmente.
...
| DNS | UDP | 53 | DNS | Utilizado para resolução de DNS pela classificação de dados 
|===