...
* link:reference-iam-predefined-roles.html["Visualizador de classificação de dados"]
...
* link:reference-iam-ransomware-roles.html["Administrador de resiliência de ransomware"]
* link:reference-iam-ransomware-roles.html["Visualizador de resiliência de ransomware"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["Comportamento do usuário de resiliência ao ransomware"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["Visualizador de comportamento do usuário de resiliência de ransomware"]
