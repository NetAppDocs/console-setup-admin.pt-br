...
keywords: role-based access, partnership access, partner resources, resource access, grant access, provide partner access, partnership organization 
...
---
= Conceda acesso a recursos para usuários parceiros no NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* link:reference-iam-keystone-roles.html["Administrador Keystone"]
* link:reference-iam-keystone-roles.html["Visualizador Keystone"]
...
. Selecione o menu de ações image:icon-action.png["um ícone com três pontos verticais"] ao lado da parceria estabelecida que deseja visualizar e selecione *Ver detalhes*.
+
