...
.Podman
--
Instale e configure o Podman:

* Habilite e inicie o serviço podman.socket
* Instalar python3
* Instale o pacote podman-compose correspondente.
* Adicione podman-compose à variável de ambiente PATH
* Verifique se a sua versão do Podman está usando o DNS Netavark Aardvark em vez do CNI.
...
. Instale o Podman.
+
Obtenha o Podman nos repositórios do Red Hat Enterprise Linux.
...
----
. Instale o EPEL para obter o podman-compose.
+
...
+
Instale uma versão compatível do Docker Engine seguindo os passos indicados. Não instale a versão mais recente, pois o Console não a suporta.
