...
summary: Você pode implantar um agente do Console na AWS diretamente do NetApp Console. Antes de implantar um agente do Console na AWS a partir do Console, você precisa configurar sua rede e preparar as permissões da AWS. 
---
= Implante um agente do Console na AWS a partir do NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Você pode implantar um agente do Console na AWS diretamente do NetApp Console. Antes de implantar um agente do Console na AWS a partir do Console, você precisa configurar sua rede e preparar as permissões da AWS.
...
Crie o agente do Console diretamente a partir do console baseado na Web do Console.
...
. Na página *Introdução*, revise a visão geral do processo.
. Na página *Credenciais da AWS*, especifique sua região da AWS e, em seguida, escolha um método de autenticação, que pode ser uma função do IAM que o Console pode assumir ou uma chave de acesso e uma chave secreta da AWS.
+
...
. Na página *Rede*, especifique uma VPC, sub-rede e par de chaves para o agente, escolha se deseja habilitar um endereço IP público e, opcionalmente, especifique uma configuração de proxy.
+
