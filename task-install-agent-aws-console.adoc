...
. Na página *Rede*, especifique uma VPC, uma sub-rede e um par de chaves para o agente, escolha se deseja habilitar um endereço IP público e, opcionalmente, especifique uma configuração de proxy.
+
