...
* *Backup e recuperação administrador de backup*: execute backups para snapshots locais, replique para storage secundário e faça backup para storage de objetos em NetApp Backup and Recovery.
* *Administrador de restauração de backup e recuperação*: Restaure cargas de trabalho usando NetApp Backup and Recovery.
* *Administrador de clonagem de backup e recuperação*: Clone aplicativos e dados usando NetApp Backup e Recovery.
