...
---
= Exigir o uso do IMDSv2 em instâncias do Amazon EC2 no NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Para novas implantações de agentes do Console a partir do Console ou usando https://docs.netapp.com/us-en/console-automation/automate/overview.html["Scripts do Terraform"^] O IMDSv2 é habilitado por padrão na instância do EC2.
...
.. https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-managing-state.html["Pare e inicie as instâncias do Cloud Volumes ONTAP"^]
