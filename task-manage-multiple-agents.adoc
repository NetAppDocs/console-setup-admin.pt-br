...
+
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-settings.html["Saiba mais sobre o modo de gerenciamento de capacidade"^]
