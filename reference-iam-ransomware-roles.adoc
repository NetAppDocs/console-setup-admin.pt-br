...
[role="lead"]
As funções de resiliência contra ransomware fornecem aos usuários acesso ao NetApp Ransomware Resilience.  As duas funções são administrador de proteção contra ransomware e visualizador de proteção contra ransomware.  A principal diferença entre as duas funções são as ações que elas podem tomar na Resiliência ao Ransomware.
