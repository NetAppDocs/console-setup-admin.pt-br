...
| Se o agente do Console estiver em uma região governamental da AWS: \https://*.blob.core.windows.net https://cloudmanagerinfraprod.azurecr.io | Para obter imagens para atualizações do agente do Console quando o agente do Console estiver instalado em uma região AWS Government. 


| Se o agente do Console estiver em uma região do Azure Government: \https://*.blob.core.windows.net https://occmclientinfragov.azurecr.us | Para obter imagens para atualizações do agente do Console quando o agente do Console estiver instalado em uma região do Azure Government. 
...
| Para obter imagens para upgrades do agente Console quando o agente Console está instalado em uma região comercial ou região soberana. [cols=3*,options="header,autowidth"] 
|===
