...
Você pode configurar uma conexão federada com o Microsoft Entra ID para habilitar o logon único (SSO) para o Console. O processo envolve configurar seu Microsoft Entra ID para confiar no Console como provedor de serviços e, em seguida, criar a conexão no Console.
...
+
.. Insira o client ID e o client secret que você criou na etapa anterior.
