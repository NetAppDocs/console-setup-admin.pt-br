...
Se você não precisa de orquestração avançada ou serviços de proteção de dados, pode gerenciar centralmente clusters ONTAP locais e serviços de storage nativos da nuvem sem implantar um agente. Algumas ferramentas de monitoramento e mobilidade de dados também estão disponíveis sem um agente.
