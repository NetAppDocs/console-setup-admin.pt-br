...
summary: O NetApp Console oferece uma experiência SaaS para acesso a todos os recursos ou uma opção auto-hospedada para organizações com restrições de conectividade. 
---
...
[role="lead"]
O NetApp Console oferece uma experiência SaaS para acesso a todos os recursos ou uma opção auto-hospedada para organizações com restrições de conectividade.

Você pode usar o NetApp Console de duas maneiras: como uma experiência SaaS totalmente gerenciada ou como uma solução auto-hospedada em seu próprio ambiente de nuvem. Com a opção SaaS, você acessa o Console através do endereço console.netapp.com, enquanto a NetApp gerencia toda a infraestrutura, autenticação e atualizações. Você terá acesso a todos os recursos diretamente do seu navegador web. Se você escolher a opção de hospedagem própria, você instala um agente do Console em seu ambiente AWS, Azure ou Google Cloud. A interface é executada localmente e o agente mantém conectividade de saída limitada com a NetApp para tarefas essenciais, como autenticação e atualizações.

Escolha a experiência SaaS se sua organização tiver conectividade padrão à internet. Você se beneficia da configuração mais simples, atualizações automáticas e acesso completo a todos os sistemas de armazenamento, serviços de dados e recursos avançados da NetApp . Você pode adicionar agentes diretamente do Console, e a NetApp cuida de toda a manutenção.

Selecione a opção de hospedagem própria se sua organização exigir conectividade, segurança ou controles de conformidade rigorosos, como em setores governamentais ou regulamentados. Você ganha mais controle e isolamento de rede, mas só pode gerenciar determinados sistemas de armazenamento NetApp e usar serviços de dados limitados, com alguns recursos indisponíveis. Você instala um agente de console manualmente e acessa o console diretamente da interface do agente local. Instale o agente através do seu marketplace na nuvem ou por meio de instalação manual, e o agente se comunicará com a NetApp somente por meio de conexões de saída, garantindo que não haja conexões de entrada pela internet.
...
image:diagram-standard-mode.png["Uma imagem conceitual que mostra a arquitetura do modo padrão com a internet pública, onde a camada SaaS e a autenticação auth0 estão disponíveis."]
...
--
Atualizações do agente do console:: A NetApp atualiza automaticamente seu agente mensalmente.
...
Como começar com o modo padrão:: Vá para o https://console.netapp.com["NetApp Console"^] e inscreva-se.
+
--
...
image:diagram-restricted-mode.png["Uma imagem conceitual do modo restrito."]
...
.9+| *Serviços de Dados* | Backup e recuperação da NetApp | Simhttps://docs.netapp.com/us-en/data-services-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-limited-internet-connectivity["Veja a lista de destinos de backup suportados para dados de volume ONTAP"^] 
