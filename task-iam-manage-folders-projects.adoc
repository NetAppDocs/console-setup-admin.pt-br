...
Você pode criar até sete níveis de pastas e projetos na estrutura de recursos da sua organização.  Crie pastas dentro de pastas para construir uma estrutura hierárquica para sua organização.
...
+
** *Nome e local*: Insira um nome e escolha um local na hierarquia para a pasta ou projeto. Coloque uma pasta ou projeto dentro da organização ou em outra pasta.
...
+
Selecione *Adicionar um membro* para atribuir acesso e uma função.
...
Modifique o acesso dos membros para controlar o acesso aos recursos.

Não é possível alterar o acesso de membros em níveis inferiores se ele for herdado de um nível hierárquico superior.   Atualize as permissões dos membros no nível hierárquico superior para alterar o acesso. Alternativamente, você podelink:task-iam-manage-roles.html#manage-permissions["gerenciar permissões na página de membros"].
