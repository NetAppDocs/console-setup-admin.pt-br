...
---
= Assine os NetApp Intelligent Services no NetApp Console modo restrito
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Antes de começar
Você já deve ter implantado um agente do Console para assinar os serviços de dados. É necessário associar uma assinatura do marketplace às credenciais de nuvem conectadas a um agente do Console.
