...
---
= Configuração padrão do agente de console no NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* O  `occm`serviço depende do serviço MySQL.
+
Se o serviço MySQL estiver inativo, então o  `occm` serviço também estará inativo.
