...
Você precisa de permissões de *Org admin* ou *Super admin* para gerenciar a identidade e o acesso da sua organização. Com permissões de *Folder or project admin*, você só pode gerenciar as pastas e os projetos aos quais tem acesso.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinco"]Verifique sua organização (opcional)
[role="quick-margin-para"]
Se sua equipe usa verificação organizacional, vincule sua organização do Console à identidade da sua conta comercial NetApp.

[role="quick-margin-para"]
link:task-verify-organization.html["Aprenda como verificar sua organização"].
...
* link:concept-verified-organization.html["Saiba mais sobre organizações verificadas no NetApp Console"]
