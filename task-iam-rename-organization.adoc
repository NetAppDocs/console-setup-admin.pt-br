...
---
= Renomeie sua organização do NetApp Console e obtenha IDs
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: 
...
[role="lead"]
Sua organização NetApp Console tem um nome e um ID. Você pode escolher um nome para sua organização para ajudar a identificá-la. Você também pode precisar saber o ID da organização para usar em chamadas de API.
...
Você pode renomear sua organização. Isso é útil se você dá suporte a mais de uma organização.
...
+
image:screenshot-iam-edit-organization.png["Uma captura de tela da página Organization mostrando o ícone de ações e a opção Edit organization."]
