...
[NOTE]
====
* O Console envia notificações por e-mail para o agente, licenças e assinaturas, NetApp Copy and Sync, NetApp Backup and Recovery e NetApp Ransomware Resilience.
