...
NOTE: Se você deseja configurar um proxy transparente, pode fazê-lo após a instalação. link:reference-agent-maint-console.html["Saiba mais sobre o console de manutenção do agente."]
