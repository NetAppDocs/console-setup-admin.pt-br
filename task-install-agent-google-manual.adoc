...
---
= Implante manualmente o agente do NetApp Console no Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Para implantar manualmente o agente do Console em seu próprio host Linux, você precisa revisar os requisitos do host, configurar sua rede, preparar as permissões do Google Cloud, habilitar as APIs do Google Cloud, instalar o Console e, em seguida, fornecer as permissões que você preparou.
...
.Antes de começar
* link:concept-agent-install-options.html#agent-cloud-manual-deploy["Saiba quando implantar manualmente no Google Cloud"].
