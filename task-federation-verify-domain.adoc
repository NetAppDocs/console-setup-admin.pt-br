...
summary: Se você deseja federar com um domínio diferente do seu domínio de e-mail, primeiro precisa verificar se é o proprietário do domínio. Você só pode usar domínios verificados para federação. 
---
...
[role="lead"]
Se você deseja federar com um domínio diferente do seu domínio de e-mail, primeiro precisa verificar se é o proprietário do domínio. Você só pode usar domínios verificados para federação.

Este fluxo de trabalho de verificação de domínio é diferente da verificação de organização. link:task-verify-organization.html["Aprenda como verificar sua organização"].
...
Por exemplo, se estiver usando o Microsoft Entra ID, você pode seguir os passos na documentação da Microsoft https://learn.microsoft.com/en-us/entra/fundamentals/add-custom-domain["Adicionar um domínio com Microsoft Entra ID"^].
