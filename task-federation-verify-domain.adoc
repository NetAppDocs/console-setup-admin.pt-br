...
Por exemplo, se estiver usando o Microsoft Entra ID, você pode seguir os passos na documentação da Microsoft link:https://learn.microsoft.com/en-us/entra/fundamentals/add-custom-domain["Adicionar um domínio com Microsoft Entra ID"].
