...
.Antes de começar
Você precisa criar um agente do Console antes de poder alterar as configurações do Console. link:concept-agents.html#agent-installation["Aprenda a criar um agente de console"] .
