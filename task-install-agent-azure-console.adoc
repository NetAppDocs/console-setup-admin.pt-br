...
. Na página *Detalhes*, insira um nome para o agente, especifique as tags e escolha se deseja que o Console crie uma nova função com as permissões necessárias ou se deseja selecionar uma função existente configurada comlink:reference-permissions-azure.html["as permissões necessárias"] .
+
