...
---
= Instale manualmente o agente do NetApp Console no Azure
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Antes de começar
* link:concept-agent-install-options.html#agent-cloud-manual-deploy["Saiba quando implantar manualmente no Azure"].
