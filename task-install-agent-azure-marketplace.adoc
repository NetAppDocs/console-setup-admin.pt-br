...
---
= Crie um agente do NetApp Console a partir do Azure Marketplace
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Antes de começar
* link:concept-agent-install-options.html#agent-marketplace-deploy["Saiba quando implantar a partir do Azure Marketplace"].
...
Certifique-se de que o local da rede onde você planeja instalar o agente do Console atenda aos seguintes requisitos. Esses requisitos permitem que o agente do Console gerencie recursos em sua nuvem híbrida.
...
.Resultado
Você instalou o agente do Console e o configurou com sua organização do Console.
