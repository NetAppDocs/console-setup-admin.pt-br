...
---
= Implante um agente do NetApp Console a partir do Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Para implantar um agente do Console no Google Cloud usando o Google Cloud, você precisa configurar sua rede, preparar as permissões do Google Cloud, ativar as APIs do Google Cloud e, em seguida, implantar o agente do Console.
