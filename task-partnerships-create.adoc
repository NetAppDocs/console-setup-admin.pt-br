...
.Resultado
A parceria que você aprovou agora exibe o status *Established*. Usuários com as funções de *Partnership admin* ou *Partnership viewer* em qualquer uma das organizações podem visualizar a parceria.
