...
[role="lead"]
Para usar os recursos e serviços do NetApp Console , você precisará fornecer permissões para que o agente do Console possa executar operações no seu ambiente de nuvem. Use os links nesta página para acessar rapidamente as permissões necessárias com base no seu objetivo.
