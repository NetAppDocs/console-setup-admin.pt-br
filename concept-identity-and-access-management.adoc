...
Sistemas de armazenamento e assinaturas Keystone:: Os sistemas de armazenamento são os principais recursos que você gerencia no NetApp Console. O NetApp Console oferece suporte ao gerenciamento de sistemas de armazenamento locais e em nuvem. Você precisa adicionar um sistema de armazenamento a um projeto antes que alguém possa acessá-lo.
+
--
